...
- Export and import support for moving your board across devices
...
## Move your board to another device

You have two simple options:

1. Click `Copy share link` and open that link on another device.
2. Click `Export board`, then use `Import board` on the other device.
